...
(function($){
  ...
  var Renderer = function(elt){
    ...
    var that = {
      init:function(pSystem){
        ...
        if (document.referrer.match(/notecardgen|easydefine|instadefine/)){
          // if we got here by hitting the back button in one of the admitsphere, 
          // start with the academictools section pre-selected
          that.switchSection('academictools')
        }
      },
      resize:function(){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['arbor.js','tutorials','sampleessays','academictools']) >=0 ){
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"admitsphere":{color:"red", shape:"dot", alpha:1}, 
      
             academictools:{color:CLR.branch, shape:"dot", alpha:1}, 
             instadefine:{color:CLR.demo, alpha:0, link:'/halfviz'},
             easydefine:{color:CLR.demo, alpha:0, link:'/easydefine'},
             notecardgen:{color:CLR.demo, alpha:0, link:'/notecardgen'},
             

             sampleessays:{color:CLR.branch, shape:"dot", alpha:1}, 
             reference:{color:CLR.doc, alpha:0, link:'#reference'},
             introduction:{color:CLR.doc, alpha:0, link:'#introduction'},

             tutorials:{color:CLR.branch, shape:"dot", alpha:1},
             collegeapps:{color:CLR.code, alpha:0, link:'https://github.com/samizdatco/arbor'},
             "sat":{color:CLR.code, alpha:0, link:'/js/dist/arbor-v0.92.zip'},
             "writing":{color:CLR.code, alpha:0, link:'/js/dist/arbor-v0.92.tar.gz'},
             
             "GoodExamplesForSAT/APEssays":{color:CLR.code, alpha:0, link:'/js/dist/arbor-v0.92.tar.gz'}
            },
      edges:{
        "admitsphere":{
          academictools:{length:.8},
          sampleessays:{length:.8},
          tutorials:{length:.8}
        },
        academictools:{instadefine:{},
               easydefine:{},
               notecardgen:{}
        },
        instadefine:{
        ...
        "GoodExamplesForSAT/APEssays":{"sat":{},
              academictools:{}
        }
      }
    }
