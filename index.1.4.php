...
<head>
  ...
  <title>IdeaOverflow -- IdeaMap</title>
    ...
    <div class="container-fluid">
      ...
      <div class="nav-collapse">
        <ul id="myTab" class="nav">
          ...
          <li class="active"><a href="#IdeaMap" data-toggle="tab">IdeaMap</a></li>
          <li><a href="#InProgress" data-toggle="tab">InProgress</a></li>
          <li><a href="#Admire" data-toggle="tab">Admire</a></li>
        </ul>
        ...
        <div class="span9 span-fixed-sidebar">
          ...
          <form id="postform">
            <div class="input-append">
              <textarea class="span11" placeholder="Enter your own cool project idea(s) here!" id="newpost"></textarea>
